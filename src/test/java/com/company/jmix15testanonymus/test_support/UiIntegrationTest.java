package com.company.jmix15testanonymus.test_support;

import com.company.jmix15testanonymus.JMix15TestAnonymusApplication;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = "com.company.jmix15testanonymus.screen")
@ContextConfiguration(classes = {JMix15TestAnonymusApplication.class, UiTestAssistConfiguration.class})
